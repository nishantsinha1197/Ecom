        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={8}>
            ...
            <Typography variant="body1" paragraph>
              ...
              affordable prices, along with excellent customer service.
            </Typography>
            <Typography variant="body1" paragraph>
              At our store, you'll find a diverse selection of products
              including electronics, fashion, home goods, and more.
            </Typography>
            <Typography variant="body1" paragraph>
              Thank you for choosing us for your online shopping needs. We look
